<div align="center">
  ...
  **This is a Storj-specific fork of [containrrr/watchtower](https://github.com/containrrr/watchtower)**
  
  [![Apache-2.0 License](https://img.shields.io/github/license/storj/watchtower.svg)](https://www.apache.org/licenses/LICENSE-2.0)
  [![latest version](https://img.shields.io/github/tag/storj/watchtower.svg)](https://github.com/storj/watchtower/releases)

</div>

## Storj-Specific Information

This fork is customized for Storj storage node operators with the following key differences:
- **Update frequency:** Checks every 6 hours (vs 24 hours in upstream) with randomization
- **Optimized for Storj nodes:** Configured specifically for Storj storage node requirements

📖 **[Read the Storj Watchtower FAQ](STORJ_FAQ.md)** for detailed answers about:
- How this differs from upstream watchtower
- Default update frequency and configuration
- Why there's no shell in the container
- Troubleshooting common issues

## Quick Start for Storj Node Operators

Watchtower automatically updates your Storj storage node and other Docker containers by pulling new images from the registry. Run the Storj watchtower container with:
...
This will check for updates every 6-12 hours (randomized) and automatically update your containers.

For Storj storage node setup and configuration, see the [official Storj documentation](https://docs.storj.io/node/get-started/install-node-software/cli/software-updates).

## Documentation

- **Storj-specific information:** [STORJ_FAQ.md](STORJ_FAQ.md)
- **General watchtower documentation:** https://containrrr.dev/watchtower
- **Storj node documentation:** https://docs.storj.io/

## Upstream Project

This is a fork of [containrrr/watchtower](https://github.com/containrrr/watchtower). For general watchtower questions not specific to Storj, please refer to the upstream documentation.
